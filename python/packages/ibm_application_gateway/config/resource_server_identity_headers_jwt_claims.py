...
class ResourceServerIdentityHeadersJwtClaims(object):
    ...
    def __init__(self, name=None, text=None, attr=None):  # noqa: E501
    ...
    def name(self):
        ...
        The name of the claim which is to be added to the JWT.   If the name is not specified, and the claim value is  obtained from an attribute name, the name of the claim  will match the name of the attribute.   # noqa: E501
    ...
    def text(self):
        ...
        The literal text to be used as the claim value.  If both a 'text' value and an 'attr' value is specified the  'text' value will be used.   # noqa: E501
