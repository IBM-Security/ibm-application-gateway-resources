...
class ResourceServerHttp2(object):
    ...
    def __init__(self, enabled=False, sni=None):  # noqa: E501
    ...
    @property
    def sni(self):
        """Gets the sni of this ResourceServerHttp2.  # noqa: E501

        The Server Name Indicator the reverse proxy will indicate to the resource server when communicating using HTTP/2.   # noqa: E501

        :return: The sni of this ResourceServerHttp2.  # noqa: E501
        :rtype: str
        """
        return self._sni
    ...
    @sni.setter
    def sni(self, sni):
        """Sets the sni of this ResourceServerHttp2.

        The Server Name Indicator the reverse proxy will indicate to the resource server when communicating using HTTP/2.   # noqa: E501

        :param sni: The sni of this ResourceServerHttp2.  # noqa: E501
        :type: str
        """
