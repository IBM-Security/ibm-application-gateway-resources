...
class PoliciesAuthorization(object):
    ...
    def __init__(self, name=None, host=None, paths=None, include_subpaths=False, methods=None, rule=None, action=None, obligation=None):  # noqa: E501
        """PoliciesAuthorization - a model defined in OpenAPI"""  # noqa: E501

        self._name = None
        self._host = None
        self._paths = None
        self._include_subpaths = None
        self._methods = None
        self._rule = None
        self._action = None
        ...
        if paths is not None:
            self.paths = paths
        if include_subpaths is not None:
            self.include_subpaths = include_subpaths
    ...
    @property
    def include_subpaths(self):
        """Gets the include_subpaths of this PoliciesAuthorization.  # noqa: E501

        Should any sub-paths of the matching path also be included in the match.   # noqa: E501

        :return: The include_subpaths of this PoliciesAuthorization.  # noqa: E501
        :rtype: bool
        """
        return self._include_subpaths

    @include_subpaths.setter
    def include_subpaths(self, include_subpaths):
        """Sets the include_subpaths of this PoliciesAuthorization.

        Should any sub-paths of the matching path also be included in the match.   # noqa: E501

        :param include_subpaths: The include_subpaths of this PoliciesAuthorization.  # noqa: E501
        :type: bool
        """

        self._include_subpaths = include_subpaths
