...
class PoliciesAuthorization(object):
    ...
    def __init__(self, name=None, host=None, paths=None, methods=None, rule=None, action=None):  # noqa: E501
    ...
    def action(self):
        ...
        Defines the action to perform if the rule matches.    # noqa: E501
