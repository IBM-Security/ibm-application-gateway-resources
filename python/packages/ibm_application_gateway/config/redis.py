...
class Redis(object):
    ...
    openapi_types = {
        ...
        'cross_domain_support': 'RedisCrossDomainSupport',
        'servers': 'list[RedisServers]'
    }
    ...
    @property
    def name(self):
        """Gets the name of this Redis.  # noqa: E501

        The name of the redis collection.   # noqa: E501

        :return: The name of this Redis.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Redis.

        The name of the redis collection.   # noqa: E501

        :param name: The name of this Redis.  # noqa: E501
        :type: str
        """
    ...
    def matching_host(self, matching_host):
        """Sets the matching_host of this Redis.

        Any specific hosts (obtained from the Host header of the HTTP request) for which this collection should be used.   # noqa: E501

        :param matching_host: The matching_host of this Redis.  # noqa: E501
        :type: str
        """
    ...
    def max_pooled_connections(self):
        """Gets the max_pooled_connections of this Redis.  # noqa: E501

        The maximum number of pooled connections to a Redis server.   # noqa: E501

        :return: The max_pooled_connections of this Redis.  # noqa: E501
        :rtype: float
        """
    ...
    def max_pooled_connections(self, max_pooled_connections):
        """Sets the max_pooled_connections of this Redis.

        The maximum number of pooled connections to a Redis server.   # noqa: E501

        :param max_pooled_connections: The max_pooled_connections of this Redis.  # noqa: E501
        :type: float
        """
    ...
    def idle_timeout(self, idle_timeout):
        """Sets the idle_timeout of this Redis.

        The maximum number of seconds a pooled connection can remain idle before the connection is closed.   # noqa: E501

        :param idle_timeout: The idle_timeout of this Redis.  # noqa: E501
        :type: float
        """
    ...
    def connect_timeout(self, connect_timeout):
        """Sets the connect_timeout of this Redis.

        The maximum number of seconds to wait for a connection to be established with a Redis server.   # noqa: E501

        :param connect_timeout: The connect_timeout of this Redis.  # noqa: E501
        :type: float
        """
    ...
    @property
    def io_timeout(self):
        """Gets the io_timeout of this Redis.  # noqa: E501

        The maximum number of seconds to wait for a valid response from a Redis server.   # noqa: E501

        :return: The io_timeout of this Redis.  # noqa: E501
        :rtype: float
        """
    ...
    def io_timeout(self, io_timeout):
        """Sets the io_timeout of this Redis.

        The maximum number of seconds to wait for a valid response from a Redis server.   # noqa: E501

        :param io_timeout: The io_timeout of this Redis.  # noqa: E501
        :type: float
        """
    ...
    def health_check_interval(self):
        """Gets the health_check_interval of this Redis.  # noqa: E501

        The interval (in seconds) between health check requests sent to the Redis server.   # noqa: E501

        :return: The health_check_interval of this Redis.  # noqa: E501
        :rtype: float
        """
    ...
    def health_check_interval(self, health_check_interval):
        """Sets the health_check_interval of this Redis.

        The interval (in seconds) between health check requests sent to the Redis server.   # noqa: E501

        :param health_check_interval: The health_check_interval of this Redis.  # noqa: E501
        :type: float
        """
    ...
    def cross_domain_support(self):
        """Gets the cross_domain_support of this Redis.  # noqa: E501


        :return: The cross_domain_support of this Redis.  # noqa: E501
        :rtype: RedisCrossDomainSupport
        """
        return self._cross_domain_support

    @cross_domain_support.setter
    def cross_domain_support(self, cross_domain_support):
        """Sets the cross_domain_support of this Redis.


        :param cross_domain_support: The cross_domain_support of this Redis.  # noqa: E501
        :type: RedisCrossDomainSupport
        """
    ...
    @property
    def servers(self):
        """Gets the servers of this Redis.  # noqa: E501

        Used to define the configuration for the individual Redis servers within the collection.   # noqa: E501

        :return: The servers of this Redis.  # noqa: E501
        :rtype: list[RedisServers]
        """
        return self._servers

    @servers.setter
    def servers(self, servers):
        """Sets the servers of this Redis.

        Used to define the configuration for the individual Redis servers within the collection.   # noqa: E501

        :param servers: The servers of this Redis.  # noqa: E501
        :type: list[RedisServers]
        """
