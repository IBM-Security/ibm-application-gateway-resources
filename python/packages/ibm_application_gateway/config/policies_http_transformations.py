...
class PoliciesHttpTransformations(object):
    ...
    def __init__(self, request=None, postazn=None, response=None):  # noqa: E501
    ...
    def request(self):
        ...
        This node defines the transformations which will take place on requests. This entry is an array and can be used to specify multiple transformations.  Example: policies:   http_transformations:     request:       - name: resource_1_rule         host: www.test.com         paths:           - \"*\"         method: GET         rule: \"@http_trans_rule.lua\"   # noqa: E501
    ...
    def postazn(self):
        ...
        This node defines the transformations which will take place on requests after authorization has been completed. This entry is  an array and can be used to specify multiple transformations.  Example: policies:   http_transformations:     postazn:       - name: resource_1_postazn_rule         host: www.test.com         paths:           - \"*\"         method: GET         rule: \"@http_trans_rule.lua\"   # noqa: E501
    ...
    def response(self):
        ...
        This node defines the transformations which will take place on responses. This entry is an array and can be used to specify multiple transformations.  Example: policies:   http_transformations:     response:       - name: resource_1_rule         host: www.test.com         paths:           - \"/resource_1\"           - \"/alt/resource_1\"         method: GET         rule: \"@http_trans_rule.lua\"       - name: legacy_xslt_rule         host: www.test.com         paths:           - \"/legacy\"         method: GET         rule: \"@legacy_rule.xsl\"         attributes:           - AZN_CRED_PRINCIPAL_NAME   # noqa: E501
