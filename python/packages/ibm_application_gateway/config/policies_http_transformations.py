...
class PoliciesHttpTransformations(object):
    ...
    openapi_types = {
        ...
        'utilities': 'list[PoliciesHttpTransformationsUtilities]'
    }
    ...
    def __init__(self, request=None, preazn=None, postazn=None, postauthn=None, response=None, secrets=None, utilities=None):  # noqa: E501
    ...
    @property
    def utilities(self):
        """Gets the utilities of this PoliciesHttpTransformations.  # noqa: E501

        This node contains utility Lua scripts that can be included and reused across multiple HTTP transformation rules. These scripts are not executed directly but can be loaded using the `require` function within any transformation rule. For example, if you define a utility script named \"common_utils\", you can include it in your transformation rules with: ``` local utils = require(\"common_utils\") ```   # noqa: E501

        :return: The utilities of this PoliciesHttpTransformations.  # noqa: E501
        :rtype: list[PoliciesHttpTransformationsUtilities]
        """
        return self._utilities

    @utilities.setter
    def utilities(self, utilities):
        """Sets the utilities of this PoliciesHttpTransformations.

        This node contains utility Lua scripts that can be included and reused across multiple HTTP transformation rules. These scripts are not executed directly but can be loaded using the `require` function within any transformation rule. For example, if you define a utility script named \"common_utils\", you can include it in your transformation rules with: ``` local utils = require(\"common_utils\") ```   # noqa: E501

        :param utilities: The utilities of this PoliciesHttpTransformations.  # noqa: E501
        :type: list[PoliciesHttpTransformationsUtilities]
        """
