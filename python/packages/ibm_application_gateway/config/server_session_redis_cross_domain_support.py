...
class ServerSessionRedisCrossDomainSupport(object):
    ...
    def __init__(self, master_authn_server_url=None, master_session_code_lifetime=30):  # noqa: E501
        """ServerSessionRedisCrossDomainSupport - a model defined in OpenAPI"""  # noqa: E501
    ...
    def master_authn_server_url(self):
        """Gets the master_authn_server_url of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        ...
        :return: The master_authn_server_url of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        :rtype: str
        """
    ...
    def master_authn_server_url(self, master_authn_server_url):
        """Sets the master_authn_server_url of this ServerSessionRedisCrossDomainSupport.

        The base URL of the master authentication server for this collection of Redis servers.  The master authentication server, if specified, will be responsible for the generation of all new sessions for this collection.  The entry should be of the format: `http{s}://server{:port}`.   # noqa: E501

        :param master_authn_server_url: The master_authn_server_url of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        :type: str
        """
    ...
    def master_session_code_lifetime(self):
        """Gets the master_session_code_lifetime of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        ...
        :return: The master_session_code_lifetime of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        :rtype: float
        """
    ...
    def master_session_code_lifetime(self, master_session_code_lifetime):
        """Sets the master_session_code_lifetime of this ServerSessionRedisCrossDomainSupport.

        The maximum number of seconds that a session code, used when communicating the session information from the master authentication server, will remain valid.   # noqa: E501

        :param master_session_code_lifetime: The master_session_code_lifetime of this ServerSessionRedisCrossDomainSupport.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerSessionRedisCrossDomainSupport):
            return False
