...
class Oauth(object):
    ...
    def __init__(self, name=None, restricted=False, introspection_endpoint=None, client_id=None, client_secret=None, client_id_hdr=None, auth_method='client_secret_post', token_type_hint='access_token', ssl=None, mapped_identity='{sub}', proxy=None, attributes=None, multi_valued_scope=True):  # noqa: E501
    ...
    def attributes(self):
        ...
        A list of JSON data elements from the introspection response token  which should be included in or excluded from the credential as an  extended attribute. See the Attributes Format table for a description  of the expected format.   # noqa: E501
