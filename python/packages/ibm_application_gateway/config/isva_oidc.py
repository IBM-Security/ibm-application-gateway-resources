...
class IsvaOidc(object):
    ...
    def __init__(self, hostname=None, client_id=None, client_secret=None, provider_details=None, ssl=None, mapped_identity='{sub}', redirect_uri_host=None, response_type=None, response_mode=None, proxy=None, scopes=None, allowed_query_args=None, bearer_token_attrs=None, id_token_attrs=None):  # noqa: E501
        """IsvaOidc - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def hostname(self):
        """Gets the hostname of this IsvaOidc.  # noqa: E501

        The fully qualified host name of the IBM Security Access Manager tenant.   # noqa: E501

        :return: The hostname of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this IsvaOidc.

        The fully qualified host name of the IBM Security Access Manager tenant.   # noqa: E501

        :param hostname: The hostname of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    @property
    def client_id(self):
        """Gets the client_id of this IsvaOidc.  # noqa: E501

        The client identity registered with IBM Security Access Manager.   # noqa: E501

        :return: The client_id of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def client_id(self, client_id):
        """Sets the client_id of this IsvaOidc.

        The client identity registered with IBM Security Access Manager.   # noqa: E501

        :param client_id: The client_id of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def client_secret(self):
        """Gets the client_secret of this IsvaOidc.  # noqa: E501

        The client secret registered with IBM Security Access Manager.   # noqa: E501

        :return: The client_secret of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def client_secret(self, client_secret):
        """Sets the client_secret of this IsvaOidc.

        The client secret registered with IBM Security Access Manager.   # noqa: E501

        :param client_secret: The client_secret of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def provider_details(self):
        """Gets the provider_details of this IsvaOidc.  # noqa: E501


        :return: The provider_details of this IsvaOidc.  # noqa: E501
        :rtype: IsvaOidcProviderDetails
        """
        return self._provider_details

    @provider_details.setter
    def provider_details(self, provider_details):
        """Sets the provider_details of this IsvaOidc.


        :param provider_details: The provider_details of this IsvaOidc.  # noqa: E501
        :type: IsvaOidcProviderDetails
        """
    ...
    @property
    def ssl(self):
        """Gets the ssl of this IsvaOidc.  # noqa: E501


        :return: The ssl of this IsvaOidc.  # noqa: E501
        :rtype: IsvaOidcSsl
        """
        return self._ssl
    ...
    @ssl.setter
    def ssl(self, ssl):
        """Sets the ssl of this IsvaOidc.


        :param ssl: The ssl of this IsvaOidc.  # noqa: E501
        :type: IsvaOidcSsl
        """
    ...
    def mapped_identity(self):
        """Gets the mapped_identity of this IsvaOidc.  # noqa: E501
        ...
        :return: The mapped_identity of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def mapped_identity(self, mapped_identity):
        """Sets the mapped_identity of this IsvaOidc.

        A formatted string which is used to construct the credential principal name from elements of the ID token. Claims can be added to the identity string, surrounded by '{}', for example:   {iss}/{sub} - would construct a principal name like the following:   https://server.example.com/248289761001   # noqa: E501

        :param mapped_identity: The mapped_identity of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def redirect_uri_host(self):
        """Gets the redirect_uri_host of this IsvaOidc.  # noqa: E501
        ...
        :return: The redirect_uri_host of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def redirect_uri_host(self, redirect_uri_host):
        """Sets the redirect_uri_host of this IsvaOidc.

        This is the host which is used in the redirect URI registered with the OIDC OP. If no redirect URI host is configured the host header from the request will be used. The format of the redirect URI will be: http[s]://\\<host\\>/pkmsoidc.   # noqa: E501

        :param redirect_uri_host: The redirect_uri_host of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def response_type(self):
        """Gets the response_type of this IsvaOidc.  # noqa: E501
        ...
        :return: The response_type of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def response_type(self, response_type):
        """Sets the response_type of this IsvaOidc.

        The required response type for authentication responses. See the Response Type Values table for a description of the available values.   # noqa: E501

        :param response_type: The response_type of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def response_mode(self):
        """Gets the response_mode of this IsvaOidc.  # noqa: E501
        ...
        :return: The response_mode of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
    ...
    def response_mode(self, response_mode):
        """Sets the response_mode of this IsvaOidc.

        The required response mode for authentication responses. If no response mode is configured the response mode parameter will not be included in the authentication request.   # noqa: E501

        :param response_mode: The response_mode of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    @property
    def proxy(self):
        """Gets the proxy of this IsvaOidc.  # noqa: E501

        Specifies the proxy, if any, which is used to reach IBM Security Access Manager. The proxy configuration entry should be in URL format. Eg: http[s]://\\<address\\>:\\<port\\>   # noqa: E501

        :return: The proxy of this IsvaOidc.  # noqa: E501
        :rtype: str
        """
        return self._proxy
    ...
    def proxy(self, proxy):
        """Sets the proxy of this IsvaOidc.

        Specifies the proxy, if any, which is used to reach IBM Security Access Manager. The proxy configuration entry should be in URL format. Eg: http[s]://\\<address\\>:\\<port\\>   # noqa: E501

        :param proxy: The proxy of this IsvaOidc.  # noqa: E501
        :type: str
        """
    ...
    def scopes(self, scopes):
        """Sets the scopes of this IsvaOidc.

        Any scopes to be sent in the authentication request in addition to the 'openid' scope.   # noqa: E501

        :param scopes: The scopes of this IsvaOidc.  # noqa: E501
        :type: list[str]
        """
    ...
    def allowed_query_args(self):
        """Gets the allowed_query_args of this IsvaOidc.  # noqa: E501
        ...
        :return: The allowed_query_args of this IsvaOidc.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_query_args(self, allowed_query_args):
        """Sets the allowed_query_args of this IsvaOidc.

        Additional query string arguments can be provided to the authentication kick-off URL which will in turn be appended to the corresponding authentication request. This entry is used to define a list of allowed query string arguments. Any other arguments passed to the kick-off URL will be ignored.   # noqa: E501

        :param allowed_query_args: The allowed_query_args of this IsvaOidc.  # noqa: E501
        :type: list[str]
        """
    ...
    def bearer_token_attrs(self):
        """Gets the bearer_token_attrs of this IsvaOidc.  # noqa: E501
        ...
        :return: The bearer_token_attrs of this IsvaOidc.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def bearer_token_attrs(self, bearer_token_attrs):
        """Sets the bearer_token_attrs of this IsvaOidc.

        A list of JSON data elements from the bearer token response which should be included or excluded in the credential as an extended attribute. See the Bearer Token Attrs Format table for a description of the expected format.   # noqa: E501

        :param bearer_token_attrs: The bearer_token_attrs of this IsvaOidc.  # noqa: E501
        :type: list[str]
        """
    ...
    def id_token_attrs(self):
        """Gets the id_token_attrs of this IsvaOidc.  # noqa: E501
        ...
        :return: The id_token_attrs of this IsvaOidc.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def id_token_attrs(self, id_token_attrs):
        """Sets the id_token_attrs of this IsvaOidc.

        A list of claims from the ID token response which should be included or excluded in the credential as an extended attribute. See the ID Token Attrs Format table for a description of the expected format.   # noqa: E501

        :param id_token_attrs: The id_token_attrs of this IsvaOidc.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsvaOidc):
            return False
