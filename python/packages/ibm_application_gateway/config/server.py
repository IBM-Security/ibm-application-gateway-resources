...
class Server(object):
    ...
    openapi_types = {
        ...
        'max_concurrent_connections_per_ip': 'float',
        'worker_threads': 'float',
        'http2': 'bool',
        'http2_tuning': 'ServerHttp2Tuning',
        'caching': 'ServerCaching',
        'client_connections': 'ServerClientConnections',
    ...
    def __init__(self, protocols=None, client_ip_rules=None, ssl=None, failover=None, session=None, max_concurrent_connections_per_ip=0, worker_threads=100, http2=True, http2_tuning=None, caching=None, client_connections=None, websocket=None, local_pages=None, management_pages=None, error_pages=None, public_assets=None, enabled_languages=None, credential_service_cache=None, local_applications=None, rate_limiting=None, content_security_policy='default', response_headers=None):  # noqa: E501
        ...
        self._failover = None
        self._session = None
        self._max_concurrent_connections_per_ip = None
        self._worker_threads = None
        self._http2 = None
        self._http2_tuning = None
        self._caching = None
        ...
        if max_concurrent_connections_per_ip is not None:
            self.max_concurrent_connections_per_ip = max_concurrent_connections_per_ip
        if worker_threads is not None:
            self.worker_threads = worker_threads
        if http2 is not None:
            self.http2 = http2
        if http2_tuning is not None:
            self.http2_tuning = http2_tuning
    ...
    @property
    def max_concurrent_connections_per_ip(self):
        """Gets the max_concurrent_connections_per_ip of this Server.  # noqa: E501
        ...
        :return: The max_concurrent_connections_per_ip of this Server.  # noqa: E501
        :rtype: float
        """
        return self._max_concurrent_connections_per_ip

    @max_concurrent_connections_per_ip.setter
    def max_concurrent_connections_per_ip(self, max_concurrent_connections_per_ip):
        """Sets the max_concurrent_connections_per_ip of this Server.

        The maximum number of concurrent connections allowed per client IP  address.  Once the maximum number of concurrent connections has been reached, subsequent connections from the client IP will not be accepted and will simply be closed.  A value of 0 indicates that an unlimited number of connections will be allowed for each client IP.   # noqa: E501

        :param max_concurrent_connections_per_ip: The max_concurrent_connections_per_ip of this Server.  # noqa: E501
        :type: float
        """
        if (max_concurrent_connections_per_ip is not None and max_concurrent_connections_per_ip < 0):  # noqa: E501
            raise ValueError("Invalid value for `max_concurrent_connections_per_ip`, must be a value greater than or equal to `0`")  # noqa: E501

        self._max_concurrent_connections_per_ip = max_concurrent_connections_per_ip
    ...
    @property
    def http2_tuning(self):
        """Gets the http2_tuning of this Server.  # noqa: E501


        :return: The http2_tuning of this Server.  # noqa: E501
        :rtype: ServerHttp2Tuning
        """
        return self._http2_tuning

    @http2_tuning.setter
    def http2_tuning(self, http2_tuning):
        """Sets the http2_tuning of this Server.


        :param http2_tuning: The http2_tuning of this Server.  # noqa: E501
        :type: ServerHttp2Tuning
        """

        self._http2_tuning = http2_tuning

    @property
    def caching(self):
        """Gets the caching of this Server.  # noqa: E501


        :return: The caching of this Server.  # noqa: E501
        :rtype: ServerCaching
        """
    ...
    def caching(self, caching):
        """Sets the caching of this Server.


        :param caching: The caching of this Server.  # noqa: E501
        :type: ServerCaching
        """
    ...
    def client_connections(self):
        """Gets the client_connections of this Server.  # noqa: E501


        :return: The client_connections of this Server.  # noqa: E501
        :rtype: ServerClientConnections
        """
        return self._client_connections

    @client_connections.setter
    def client_connections(self, client_connections):
        """Sets the client_connections of this Server.


        :param client_connections: The client_connections of this Server.  # noqa: E501
        :type: ServerClientConnections
        """
