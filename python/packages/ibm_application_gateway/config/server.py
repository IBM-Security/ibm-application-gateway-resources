...
class Server(object):
    ...
    def __init__(self, protocols=None, ssl=None, failover=None, session=None, worker_threads=100, max_ratelimiting_buckets=16384, http2=False, websocket=None, local_pages=None, management_pages=None, error_pages=None, credential_service_cache=None, local_applications=None):  # noqa: E501
    ...
    def protocols(self):
        ...
        Specifies the protocols which will be supported by the server.  The server will listen on a different port for each protocol:  http/8080 and https/8443.  If no protocol is specified the server will listen for https requests only.   # noqa: E501
