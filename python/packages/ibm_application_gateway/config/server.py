...
class Server(object):
    ...
    def __init__(self, protocols=None, client_ip_rules=None, ssl=None, failover=None, session=None, worker_threads=100, http2=False, websocket=None, local_pages=None, management_pages=None, error_pages=None, credential_service_cache=None, local_applications=None, rate_limiting=None):  # noqa: E501
