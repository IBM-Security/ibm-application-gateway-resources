...
class Server(object):
    ...
    def __init__(self, protocols=None, ssl=None, failover=None, session=None, worker_threads=100, max_ratelimiting_buckets=16384, http2=False, websocket=None, local_pages=None, management_pages=None, error_pages=None, local_applications=None):  # noqa: E501
