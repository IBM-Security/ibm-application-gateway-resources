...
class ServicesRedisCollections(object):
    ...
    def health_check_interval(self):
        ...
        The interval (in seconds) between health check requests sent to the Redis server. If set to 0, health checks will not be performed (other than an initial health check which is  required).   # noqa: E501
    ...
    def health_check_interval(self, health_check_interval):
        ...
        :type: float
        """
        if (health_check_interval is not None and health_check_interval < 0):  # noqa: E501
            raise ValueError("Invalid value for `health_check_interval`, must be a value greater than or equal to `0`")  # noqa: E501
