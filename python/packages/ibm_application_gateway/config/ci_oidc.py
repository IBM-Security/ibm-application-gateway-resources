...
class CiOidc(object):
    ...
    def __init__(self, hostname=None, client_id=None, client_secret=None, mapped_identity='{sub}', redirect_uri_host=None, response_type=None, response_mode=None, proxy=None, scopes=None, allowed_query_args=None, bearer_token_attrs=None, id_token_attrs=None):  # noqa: E501
    ...
    def hostname(self):
        ...
        The fully qualified host name of the IBM Cloud Identity tenant.    # noqa: E501
    ...
    def client_id(self):
        ...
        The client identity registered with IBM Cloud Identity.   # noqa: E501
    ...
    def client_secret(self):
        ...
        The client secret registered with IBM Cloud Identity.   # noqa: E501
    ...
    def proxy(self):
        ...
        Specifies the proxy, if any, which is used to reach IBM Cloud Identity. The proxy configuration entry should be in URL format. Eg: http[s]://\\<address\\>:\\<port\\>   # noqa: E501
