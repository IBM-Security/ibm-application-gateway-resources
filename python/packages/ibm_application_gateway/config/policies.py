...
class Policies(object):
    ...
    openapi_types = {
        ...
        'waf': 'PoliciesWaf',
        'request_headers': 'list[PoliciesRequestHeader]'
    }
    ...
    def __init__(self, http_transformations=None, cors=None, rate_limiting=None, content_injection=None, authorization=None, waf=None, request_headers=None):  # noqa: E501
    ...
    def cors(self):
        ...
        The reverse proxy can support cross-origin resource sharing with CORS aware clients. Each defined policy must at a minimum contain:   * name   * method   * policy:allow_origins  This entry is an array and can be used to specify multiple CORS policies.   # noqa: E501
    ...
    def rate_limiting(self):
        ...
        The gateway can apply rate limiting to incoming requests. This entry defines the rate limiting policies and where they will be applied. Refer to the documentation for information about how to author a rate-limiting policy. This entry is an array and can be used to define multiple policies.   # noqa: E501
    ...
    def content_injection(self):
        ...
        The gateway can inject content into responses. This entry defines the content and when injection should take place. Content injection is performed based on the request path and a specific location within the response. This entry is an array and can define multiple content injection points.   # noqa: E501
    ...
    @property
    def waf(self):
        """Gets the waf of this Policies.  # noqa: E501


        :return: The waf of this Policies.  # noqa: E501
        :rtype: PoliciesWaf
        """
        return self._waf
    ...
    @waf.setter
    def waf(self, waf):
        """Sets the waf of this Policies.


        :param waf: The waf of this Policies.  # noqa: E501
        :type: PoliciesWaf
        """
    ...
    def request_headers(self):
        """Gets the request_headers of this Policies.  # noqa: E501

        This entry can be used to set HTTP headers which are set in requests sent to all resource servers. For each entry, only one of `request_property`, `credential_attribute`, `http_header` or `text` can be specified.   # noqa: E501

        :return: The request_headers of this Policies.  # noqa: E501
        :rtype: list[PoliciesRequestHeader]
        """
        return self._request_headers

    @request_headers.setter
    def request_headers(self, request_headers):
        """Sets the request_headers of this Policies.

        This entry can be used to set HTTP headers which are set in requests sent to all resource servers. For each entry, only one of `request_property`, `credential_attribute`, `http_header` or `text` can be specified.   # noqa: E501

        :param request_headers: The request_headers of this Policies.  # noqa: E501
        :type: list[PoliciesRequestHeader]
        """
