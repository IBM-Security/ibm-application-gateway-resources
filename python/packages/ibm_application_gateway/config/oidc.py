...
class Oidc(object):
    ...
    def discovery_endpoint(self):
        ...
        The fully qualified discovery endpoint for the OIDC OP.<br/> For IBM Cloud Identity, this URL is usually in the format:<br/> https://<ci-hostname\\>/oidc/endpoint/default/.well-known/openid-configuration <br/> For IBM Security Access Manager, this URL is usually in the format:<br/> https://<isam-hostname\\>/\\<junction\\>/sps/oauth/oauth20/metadata/\\<definition_name\\>   # noqa: E501
