...
class Oidc(object):
    ...
    def __init__(self, discovery_endpoint=None, client_id=None, client_secret=None, ssl=None, mapped_identity='{sub}', redirect_uri_host=None, response_type='code', response_mode=None, proxy=None, scopes=None, allowed_query_args=None, bearer_token_attrs=None, id_token_attrs=None):  # noqa: E501
