...
class ResourceServer(object):
    ...
    openapi_types = {
        ...
        'request_headers': 'list[ResourceServerRequestHeader]'
    }
    ...
    def __init__(self, path=None, virtual_host=None, connection_type='tcp', transparent_path=False, stateful=False, http2=None, sni=None, identity_headers=None, cookies=None, mutual_auth=None, servers=None, aliases=None, forms_login=None, health=None, worker_threads=None, persistent_connections=None, identity=None, request_headers=None):  # noqa: E501
    ...
    def request_headers(self):
        """Gets the request_headers of this ResourceServer.  # noqa: E501

        This entry can be used to set HTTP headers which are set in requests sent to this resource server. These entries are processed after the global  request headers specified under policies, so can be used to overwrite or append to request headers specified in that section. For each entry, only one of `request_property`, `credential_attribute`, `http_header` or `text` can be specified.   # noqa: E501

        :return: The request_headers of this ResourceServer.  # noqa: E501
        :rtype: list[ResourceServerRequestHeader]
        """
        return self._request_headers

    @request_headers.setter
    def request_headers(self, request_headers):
        """Sets the request_headers of this ResourceServer.

        This entry can be used to set HTTP headers which are set in requests sent to this resource server. These entries are processed after the global  request headers specified under policies, so can be used to overwrite or append to request headers specified in that section. For each entry, only one of `request_property`, `credential_attribute`, `http_header` or `text` can be specified.   # noqa: E501

        :param request_headers: The request_headers of this ResourceServer.  # noqa: E501
        :type: list[ResourceServerRequestHeader]
        """
