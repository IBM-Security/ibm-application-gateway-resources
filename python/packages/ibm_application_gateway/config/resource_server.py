...
class ResourceServer(object):
    ...
    def __init__(self, path=None, virtual_host=None, connection_type='tcp', transparent_path=False, stateful=False, http2=None, sni=None, identity_headers=None, cookies=None, mutual_auth=None, servers=None, forms_login=None, health=None, worker_threads=None, persistent_connections=None, identity=None):  # noqa: E501
    ...
    def path(self):
        ...
        The path at which the resource server will be made available. This entry is required if the `virtual_host` entry has not been specified. It is not valid to have both `path` and `virtual_host` entries specified.  Example: resource_servers:   - path: /static     # ...   # noqa: E501
    ...
    def sni(self):
        ...
        The Server Name Indicator the reverse proxy will indicate to the resource server during TLS negotiation.  Example: resource_servers:   - path: \"/example\"     connection_type: ssl     # ...     sni: www.test.com   # noqa: E501
