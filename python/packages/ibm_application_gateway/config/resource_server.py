...
class ResourceServer(object):
    ...
    def __init__(self, path=None, virtual_host=None, connection_type='tcp', transparent_path=False, stateful=False, http2=None, identity_headers=None, cookies=None, mutual_auth=None, servers=None, health=None, worker_threads=None, persistent_connections=None):  # noqa: E501
