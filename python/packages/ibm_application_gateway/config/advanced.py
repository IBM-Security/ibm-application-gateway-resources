...
class Advanced(object):
    ...
    def configuration(self):
        ...
        This entry defines customize legacy reverse proxy daemon configuration entries. This configuration is applied last and can be used to overload parameters specified in other sections of the configuration YAML.   This entry is an array and can be used to specify multiple tuning parameters. Example: advanced:              configuration:                  - stanza: server                    entry: web-http-port                    operation: set                    value: [\"80\"]                  - stanza: server                    entry: web-https-port                    operation: set                    value: [\"443\"]     # noqa: E501
