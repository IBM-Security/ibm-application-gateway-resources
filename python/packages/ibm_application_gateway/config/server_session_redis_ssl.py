...
class ServerSessionRedisSsl(object):
    ...
    def __init__(self, trust_certificates=None, client_certificate=None, sni=None):  # noqa: E501
        """ServerSessionRedisSsl - a model defined in OpenAPI"""  # noqa: E501
    ...
    def trust_certificates(self):
        """Gets the trust_certificates of this ServerSessionRedisSsl.  # noqa: E501
        ...
        :return: The trust_certificates of this ServerSessionRedisSsl.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def trust_certificates(self, trust_certificates):
        """Sets the trust_certificates of this ServerSessionRedisSsl.

        The PEM based certificates which are to be  trusted when communicating with the Redis  server.  The trusted certificates should  include the CA certificate for the Redis server  certificate, as well as any intermediate  certificates used to sign the client  certificate (if mutual authentication is in  use).  SSL/TLS will not be used when  communicating with the Redis server if no  trust certificates are specified.   # noqa: E501

        :param trust_certificates: The trust_certificates of this ServerSessionRedisSsl.  # noqa: E501
        :type: list[str]
        """
    ...
    def client_certificate(self):
        """Gets the client_certificate of this ServerSessionRedisSsl.  # noqa: E501
        ...
        :return: The client_certificate of this ServerSessionRedisSsl.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def client_certificate(self, client_certificate):
        """Sets the client_certificate of this ServerSessionRedisSsl.

        The PEM based personal certificate files which  will be used when performing mutual  authentication with the resource server.  These  certificate files should include the private  key, a certificate signed with the private key,  and the signer certificate or signer  certificate chain (if required).   # noqa: E501

        :param client_certificate: The client_certificate of this ServerSessionRedisSsl.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def sni(self):
        """Gets the sni of this ServerSessionRedisSsl.  # noqa: E501
        ...
        :return: The sni of this ServerSessionRedisSsl.  # noqa: E501
        :rtype: str
        """
        return self._sni
    ...
    @sni.setter
    def sni(self, sni):
        """Sets the sni of this ServerSessionRedisSsl.

        The Server Name Indication (SNI) value which  is provided when establishing the SSL connection with the Redis server.   # noqa: E501

        :param sni: The sni of this ServerSessionRedisSsl.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerSessionRedisSsl):
            return False
