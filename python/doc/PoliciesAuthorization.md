...
**paths** | **list[str]** | The paths which this policy will be applied. Each path may contain the &#x60;*?&#x60; pattern matching characters. This entry is an array and can be used to specify multiple paths.  Please note that if a character immediately follows the &#39;*&#39;, the wildcard will  match any sequence of characters up to but not including the first  occurrence of that specific character.  For example, the path \&quot;/foo/*a\&quot; will match \&quot;/foo/ba\&quot; but not \&quot;/foo/baa\&quot;.    | [optional] 
**include_subpaths** | **bool** | Should any sub-paths of the matching path also be included in the match.  | [optional] [default to False]
