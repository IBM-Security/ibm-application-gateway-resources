...
**utilities** | [**list[PoliciesHttpTransformationsUtilities]**](PoliciesHttpTransformationsUtilities.md) | This node contains utility Lua scripts that can be included and reused across multiple HTTP transformation rules. These scripts are not executed directly but can be loaded using the &#x60;require&#x60; function within any transformation rule. For example, if you define a utility script named \&quot;common_utils\&quot;, you can include it in your transformation rules with: &#x60;&#x60;&#x60; local utils &#x3D; require(\&quot;common_utils\&quot;) &#x60;&#x60;&#x60;  | [optional] 
