...
const SAMPLE_EMPTY_YAML = "version: 25.06";
...
const SAML_AUTHZ_YAML = "version: \"25.06\"\n" +
                        "#\n" +
...
const SAMPLE_BASIC_YAML = "version: \"25.06\"\n" +
                          "\n" +
                          "#\n" +
...
const SAMPLE_ISVA_YAML =  "version: \"25.06\"\n" +
                          "\n" +
                          "#\n" +
                          "# Configure an IAG container with a very basic configuration.  This \n" +
                          "# configuration will simply define a server certificate, and configure an IBM \n" +
...
const SAMPLE_CREDVIEWER_YAML = "version: \"25.06\"\n" +
                               "\n" +
                               "#\n" +
                               "# Configure an IAG container with a very basic configuration.  This \n" +
...
const SAMPLE_LWP_YAML = "version: \"25.06\"\n" +
                        "\n" +
                        "#\n" +
                        "# Configure an IAG container with a very basic configuration.  This \n" +
                        "# configuration will simply define a server certificate, configure an IBM\n" + 
...
const SAMPLE_RL_YAML = "version: \"25.06\"\n" +
                      "\n" +
                      "#\n" +
...
const SAMPLE_STDAPP_YAML = "version: \"25.06\"\n" +
                          "\n" +
                          "#\n" +
                          "# Configure an IAG container to proxy a single Web application.  This \n" +
                          "# configuration will simply define a server certificate, configure an IBM \n" +
...
const SAMPLE_TRACING_YAML = "version: \"25.06\"\n" +
                            "\n" +
                            "#\n" +
...
const SAMPLE_UNAUTH_YAML = "version: \"25.06\"\n" +
                           "\n" +
                          "#\n" +
...
const SAMPLE_ISV_2FA_YAML = "version: \"25.06\"\n" +
                             "\n" +
                            "#\n" +
                            "# Configure an IAG container to proxy a single Web application, and define\n" +
...
const SAMPLE_VH_YAML = "version: \"25.06\"\n" +
                       "\n" +
                      "#\n" +
...
const SAMPLE_HTTPTRAN_YAML = "version: \"25.06\"\n" +
                             "\n" +
                            "#\n" +
                            "# Configure an IAG container to proxy a single Web application.  This \n" +
                            "# configuration will simply define a server certificate, configure an IBM \n" +
...
const SAMPLE_OAUTH_ISVA_YAML = "version: \"25.06\"\n" +
                               "\n" +
                              "#\n" +
                              "# Configure an IAG container with a very basic configuration.  This \n" +
                              "# configuration will simply define a server certificate, and configure an IBM \n" +
...
const SAMPLE_OAUTH_ISV_YAML = "version: \"25.06\"\n" +
                              "\n" +
                              "#\n" +
                              "# Configure an IAG container with a very basic configuration.  This \n" +
                              "# configuration will simply define a server certificate, and configure an IBM \n" +
