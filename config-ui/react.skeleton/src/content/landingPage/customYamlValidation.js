/**
 * This js file is a copy of the ACE mode-yaml.js file but has a custom worker
 * that includes YAML and IAG validation.
 */

// IAG Update: Wrap the entire file in an export that allows the ace module to be passed in and used locally.
export default (ace) => {
    ...
    // IAG Update: Add custom YAML validator
    ...
    (function() {
        ...
        this.createWorker = function(session) {
            ...
            // IAG: Notify the worker to load the js-yaml.jar from the "real" url.
            // Need this because the blob functionality overrides the location.pathname
            worker.$worker.postMessage({loadJsYaml: "true", url: window.location.origin + window.location.pathname});
...
} // IAG Update: Close encapsulating export